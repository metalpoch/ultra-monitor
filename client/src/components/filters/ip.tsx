...
export default function TrafficFilter() {
    return (
        <aside className="w-fit h-full min-w-fit px-4 py-6 bg-white flex flex-col items-center justify-center gap-4 rounded-xl md:w-1/2 max-sm:w-full max-sm:gap-3">
